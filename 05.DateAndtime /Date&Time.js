...
// -> You can create a new Date object by calling the Date constructor with or 
// without arguments. If no arguments are provided, it will create a Date object 
...
// You can extract various parts of a Date object, such as the year, month, 
// day, hours, minutes, seconds, etc.
const date = new Date();
...
console.log(date.toDateString()); // Output: Sat Aug 17 2024

console.log(date.toISOString()); // Output: 2024-08-17T00:00:00.000Z
console.log(date.toLocaleString()); // Output: 8/17/2024, 7:56:51 AM(based on the user's local timezone)
// ------------------------------------
